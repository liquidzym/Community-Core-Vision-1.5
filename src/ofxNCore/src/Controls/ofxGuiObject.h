...
public:
	...
	string			pointToString(ofVec2f value, int display);
	
	bool			isPointInsideMe(int x, int y);
	bool			isPointInsideMe(ofVec2f point);
	
	ofVec2f		mouseToLocal(int x, int y);
	ofVec2f		mouseToFraction(ofVec2f mouse);
	ofVec2f		fractionToLocal(ofVec2f fraction);
