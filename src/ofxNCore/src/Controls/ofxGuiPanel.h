...
public:
	...
	ofxGuiObject*	addXYPad(int id, string name, int width, int height, ofVec2f min, ofVec2f max, ofVec2f value, int display, int steps);
	ofxGuiObject*	addPoints(int id, string name, int width, int height, ofVec2f min, ofVec2f max, ofVec2f value, int display, int steps);
	...
	ofxGuiObject*	addScope(int id, string name, int width, int height, int length, ofVec2f value, int display);
